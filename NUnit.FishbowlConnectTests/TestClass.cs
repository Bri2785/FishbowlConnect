    ...
    public class TestClass
    {
        ...
        public async Task MoveInventoryImportTest(string partNumber)
        {
            ...
            //{
                ...
                using (FishbowlSession session = new FishbowlSession(config))
                {
                    List<InvQtyWithTracking> invQtyWithTrackings = null;
                    ...
                    {
                        invQtyWithTrackings = await db.GetPartTagAndTracking(partNumber);
                        ...
                        InvQtyWithTracking invQty = invQtyWithTrackings[0];
                        ...
                        int newqty = (int)(await db.GetPartTagAndTracking(partNumber))
        ...
        public async Task AddInventoryImportTest(string partNumber, string LocationName)
        {
            ...
            //SessionConfig config = new SessionConfig(GoodServerAddress, 28192, GoodUserName, GoodPassword);
            SessionConfig config = new SessionConfig("192.168.150.2", 28192, GoodUserName, GoodPassword);
