...
namespace FishbowlConnect.Helpers.IO
{
    /// <summary>
    ...
    /// </summary>
    public class EndianBinaryReadConverter : IDisposable
    {
        ...
        public EndianBinaryReadConverter(EndianBitConverter bitConverter,
                                   Stream stream)
        ...
        public EndianBinaryReadConverter(EndianBitConverter bitConverter, Stream stream, Encoding encoding)
        {
        ...
        Stream stream;
        /// <summary>
        /// Gets the underlying stream of the EndianBinaryReadConverter.
        /// </summary>
        ...
        void CheckDisposed()
        {
            if (disposed)
            {
                throw new ObjectDisposedException("EndianBinaryReadConverter");
            }
        }
